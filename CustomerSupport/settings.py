...
SECRET_KEY = 'django-insecure-5j5t77cnhxhk_5yl4=qlw5xpsh)fyjvoan52%k*qcaz%8xi!t+'
...
connect(
    ...
    authentication_source='admin'  # Replace with your MongoDB authentication source
)

# Minimal SQL database configuration for Django's built-in features
DATABASES = {
    'default': {
